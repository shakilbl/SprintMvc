...
import com.macrocom.model.Employee;

/**
 * Home object for domain model class Employee.
 * @see com.macrocom.dao.Employee
...
public class EmployeeHome {
	...
	public Employee findById(int id) {
		...
		try {
			Employee instance = (Employee) sessionFactory.getCurrentSession().get("com.macrocom.dao.Employee", id);
			if (instance == null) {
	...
	public List findByExample(Employee instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.macrocom.dao.Employee")
